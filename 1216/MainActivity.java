...
public class MainActivity extends AppCompatActivity {
    ...
    public void gradeCal(View v) {
        ...
        int newScore = et[0] + et[1] + et[2] + et[3] + et[4] + et[5] + et[6] + et[7];
        int passCount = 0;
        ...
        for(int i=0; i<8; i++) {
            if (selectedItemName[i].equals("A+"))
                ...
                sn[i] = 1.0;
            else if (selectedItemName[i].equals("P")) {
                sn[i] = 0.0;
                passCount += et[i];
                newScore -= et[i];
                et[i] = 0;
            } else if (selectedItemName[i].equals("NP")) {
                sn[i] = 0.0;
                //취득학점에서 NP 학점 제거
                scoreNum3 -= et[i];
                newScore -= et[i];
            ...
            //F는 et가 0이 아니야!!!!!!!!!!
            else if (selectedItemName[i].equals("F")) {
                sn[i] = 0.0;
                //취득학점에서 F 학점 제거
                scoreNum3 -= et[i];
            }
        ...
        //취득학점
        //scoreNum1 의 분모에 P 빼야됨(학점을!!!!)
        double scoreNum1 = (et[0] * sn[0] + et[1] * sn[1] + et[2] * sn[2] + et[3] * sn[3]
                + et[4] * sn[4] + et[5] * sn[5] + et[6] * sn[6] + et[7] * sn[7]) / newScore;
